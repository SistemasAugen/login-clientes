...
Route::prefix('admin')->group(function () {
	...
	Route::middleware(["auth:sanctum"])->group(function(){
		...
		Route::post('/getSubcategories', [App\Http\Controllers\SubcategoryController::class, 'getSubcategories']);
		...
		Route::delete('/brands', [App\Http\Controllers\BrandController::class, 'destroyMultiple']);

		//breeds
		Route::get('/breeds', [App\Http\Controllers\BreedController::class, 'index']);
		Route::get('/breeds/{id}', [App\Http\Controllers\BreedController::class, 'show']);
		Route::post('/breeds', [App\Http\Controllers\BreedController::class, 'store']);
		Route::post('/breeds/{id}', [App\Http\Controllers\BreedController::class, 'update']);
		Route::delete('/breeds/{id}', [App\Http\Controllers\BreedController::class, 'destroy']);
		Route::delete('/breeds', [App\Http\Controllers\BreedController::class, 'destroyMultiple']);
