...
const MyRouter = new VueRouter({
  	routes:[
		...
		//Marcas
		{ path: '/brands', component: require(page+'brands/index.vue').default, meta:{title:"Marcas" }},
		{ path: '/brands/edit', component: require(page+'brands/edit.vue').default, meta:{title:"Editar" }},
		{ path: '/brands/edit/:id', component: require(page+'brands/edit.vue').default, meta:{title:"Editar"}},

		//raza
		{ path: '/breeds', component: require(page+'breeds/index.vue').default, meta:{title:"Razas" }},
		{ path: '/breeds/edit', component: require(page+'breeds/edit.vue').default, meta:{title:"Editar" }},
		{ path: '/breeds/edit/:id', component: require(page+'breeds/edit.vue').default, meta:{title:"Editar"}},
	  ]
});
...
Vue.use(VueDocumentTitlePlugin, MyRouter,
	{ defTitle: "Paw", filter: (title)=>{ return title+" - Paw"; } }
);
