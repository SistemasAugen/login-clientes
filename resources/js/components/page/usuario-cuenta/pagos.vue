                            ...
                            <div class="media-body my-auto text-right">
                                <div class="row my-auto flex-column flex-md-row">
                                    <div class="col-auto my-auto ">
                                        <h6 class="mb-0"><router-link :to="'/usuario/receta/'+order.id">{{ order.id }}</router-link></h6>
                                    </div>
                                    ...
                                    <div class="col my-auto ">
                                        <a type="button" class="btn btn-red btn-form" variant="primary"  style="color:white">Pagar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
