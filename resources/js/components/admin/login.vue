<template>
	...
	<div class="login-container">
		...
		<div class="login-form" style="background-color: #c92624;">
			...
			<div class="login-content">
				...
				<form method="post" @submit.prevent="$root.handleLogin">
					...
					<div class="form-group">
						...
						<div class="input-group" style="background-color: #eb585a;border-color: #eb585a;">
					...
					<div class="form-group">
						<button type="submit" class="btn btn-primary btn-block btn-login" style="background-color: #eb585a;border-color: #eb585a;text-align: center;">
