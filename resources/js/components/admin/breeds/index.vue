<template>
    <div>
      <ol class="breadcrumb 2">
              ...
              <li class="active"><strong>Razas</strong></li>
          </ol>
          <h2 class="margin-bottom">Razas</h2>
  
          <div class="row">
              <div class="col-md-12">
                  <div id="toolbar">
                      <router-link to="/breeds/edit">
    ...
    methods:{
      mounthTable(){
        ...
        jQuery('#table').on('click-row.bs.table',(row,data)=>{
          this.$router.push('/breeds/edit/'+data.id);
        });
      ...
      deleteRows:function(){
        ...
        alertify.confirm("Alerta!","¿Seguro que deseas borrar "+rows.length+" registros?",()=>{
          ...
          axios.delete(tools.url('/api/admin/breeds'),{data:params})
          .then((response)=>{
